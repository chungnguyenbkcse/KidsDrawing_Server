...
public interface SemesterClassService {
    ...
    ResponseEntity<Map<String, Object>> getAllSemesterClassNewByParentAndCourse(Long id, Long course_id);
    ResponseEntity<Map<String, Object>> getAllSemesterClassNewByTeacherAndCourse(Long id, Long course_id);
