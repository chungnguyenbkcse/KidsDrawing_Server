...
public interface SectionService {
    ...
    ResponseEntity<Map<String, Object>> getAllSectionByAdmin();
    ...
    Long deleteTutorialTemplatePageBySection(Long id);
    Long createTutorialPageBySection(Long id, CreateTutorialTemplatePageRequest createTutorialTemplatePageRequest);
    Long removeSectionById(Long id);
    Long updateSectionById(Long id, CreateSectionRequest createSectionRequest);
    Long updateSectionByAdmin(Long id, CreateSectionRequest createSectionRequest);
}
