...
public class SectionServiceImpl implements SectionService{
    ...
    public ResponseEntity<Map<String, Object>> getAllSection() {
        ...
        listSection.forEach(content -> {
            GetSectionStudentResponse sectionResponse = GetSectionStudentResponse.builder()
                ...
                .teacher_name(content.getClasses().getUserRegisterTeachSemester().getTeacher().getUser().getUsername() + " - " + content.getClasses().getUserRegisterTeachSemester().getTeacher().getUser().getFirstName() + " " + content.getClasses().getUserRegisterTeachSemester().getTeacher().getUser().getLastName())
    ...
    public GetSectionStudentResponse getSectionById(Long id) {
        ...
        return GetSectionStudentResponse.builder()
            ...
            .teacher_name(section.getClasses().getUserRegisterTeachSemester().getTeacher().getUser().getUsername() + " - " + section.getClasses().getUserRegisterTeachSemester().getTeacher().getUser().getFirstName() + " " + section.getClasses().getUserRegisterTeachSemester().getTeacher().getUser().getLastName())
