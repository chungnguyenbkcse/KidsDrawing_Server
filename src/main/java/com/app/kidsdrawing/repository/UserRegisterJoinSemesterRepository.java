...
public interface UserRegisterJoinSemesterRepository extends JpaRepository <UserRegisterJoinSemester, Long>{
    ...
    @Query("SELECT e FROM UserRegisterJoinSemester e JOIN FETCH e.student  st JOIN FETCH st.parent JOIN FETCH e.semesterClass ORDER BY e.id")
    List<UserRegisterJoinSemester> findAll();

    @Query("SELECT DISTINCT e FROM UserRegisterJoinSemester e JOIN FETCH e.student  st JOIN FETCH st.parent JOIN FETCH e.semesterClass sc JOIN FETCH sc.course JOIN FETCH sc.semester ORDER BY e.id")
    List<UserRegisterJoinSemester> findAll1();

    @Query("SELECT DISTINCT e FROM UserRegisterJoinSemester e JOIN FETCH e.student  st JOIN FETCH st.parent JOIN FETCH e.semesterClass sc JOIN FETCH sc.course WHERE e.status = 'Completed'")
    ...
    @Query(
		value = "SELECT e FROM UserRegisterJoinSemester e JOIN FETCH e.student  st JOIN FETCH st.parent JOIN FETCH e.semesterClass ORDER BY e.id",
		countQuery = "SELECT e FROM UserRegisterJoinSemester e INNER JOIN e.student  INNER JOIN e.semesterClass "
	)
    ...
    @Query("FROM UserRegisterJoinSemester e JOIN FETCH e.student  st JOIN FETCH st.parent JOIN FETCH e.semesterClass WHERE e.id = ?1")
    ...
    @Query("FROM UserRegisterJoinSemester e JOIN FETCH e.semesterClass sc JOIN FETCH e.student  st JOIN FETCH st.parent WHERE sc.id = ?1 ORDER BY e.id")
    List<UserRegisterJoinSemester> findBySemesterClassId2(Long id);

    @Query("SELECT DISTINCT e FROM UserRegisterJoinSemester e JOIN FETCH e.semesterClass sc JOIN FETCH e.student  st JOIN FETCH st.parent  WHERE sc.id = ?1 AND e.status = 'Completed' ORDER BY e.id")
    ...
    @Query("FROM UserRegisterJoinSemester e JOIN FETCH e.student st JOIN FETCH st.parent JOIN FETCH e.semesterClass sc JOIN FETCH sc.semester s JOIN FETCH sc.course c WHERE st.id = ?1 ORDER BY e.id")
    List<UserRegisterJoinSemester> findByStudentId2(Long id);

    @Query("FROM UserRegisterJoinSemester e JOIN FETCH e.student st JOIN FETCH st.parent JOIN FETCH e.semesterClass sc JOIN FETCH sc.semester s JOIN FETCH sc.course c WHERE st.id = ?1 AND e.status = 'Completed' ORDER BY e.id")
    List<UserRegisterJoinSemester> findByStudentId3(Long id);

    @Query("FROM UserRegisterJoinSemester e JOIN FETCH e.student st JOIN FETCH st.parent pa WHERE pa.id = ?1 ORDER BY e.id")
    List<UserRegisterJoinSemester> findByPayerId1(Long id);

    @Query("FROM UserRegisterJoinSemester e JOIN FETCH e.student st JOIN FETCH st.parent pa JOIN FETCH e.semesterClass sc JOIN FETCH sc.course c WHERE pa.id = ?1 ORDER BY e.id")
    List<UserRegisterJoinSemester> findByPayerId2(Long id);

    @Query("FROM UserRegisterJoinSemester e JOIN FETCH e.student st JOIN FETCH st.parent pa JOIN FETCH e.semesterClass sc JOIN FETCH sc.course c JOIN FETCH sc.semester WHERE pa.id = ?1 AND e.status = 'Completed' ORDER BY e.id")
