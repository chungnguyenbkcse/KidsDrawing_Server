...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/semester-class/**").hasAnyAuthority("ADMIN_USER")
                .antMatchers(HttpMethod.PUT, "/api/v1/semester-class/**").hasAnyAuthority("ADMIN_USER")
                .antMatchers(HttpMethod.DELETE, "/api/v1/semester-class/**").hasAnyAuthority("ADMIN_USER")
