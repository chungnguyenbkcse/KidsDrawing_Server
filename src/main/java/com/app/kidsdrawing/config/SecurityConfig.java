...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/user-grade-exercise-submission/**").permitAll()
                .antMatchers(HttpMethod.PUT, "/api/v1/user-grade-exercise-submission/**").permitAll()
                .antMatchers(HttpMethod.DELETE, "/api/v1/user-grade-exercise-submission/**").permitAll()
                .antMatchers(HttpMethod.GET, "/api/v1/user-grade-contest-submission/**").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/user-grade-contest-submission/**").permitAll()
                .antMatchers(HttpMethod.PUT, "/api/v1/user-grade-contest-submission/**").permitAll()
                .antMatchers(HttpMethod.DELETE, "/api/v1/user-grade-contest-submission/**").permitAll()
