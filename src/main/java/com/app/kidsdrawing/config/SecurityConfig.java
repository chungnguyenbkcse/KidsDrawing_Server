...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.PUT, "/api/v1/class-has-register-join-semester/**").hasAnyAuthority("TEACHER_USER", "PARENT_USER", "ADMIN_USER")
                .antMatchers(HttpMethod.GET, "/api/v1/user-register-tutorial/**").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/user-register-tutorial/**").hasAnyAuthority("TEACHER_USER")
                .antMatchers(HttpMethod.PUT, "/api/v1/user-register-tutorial/**").hasAnyAuthority("TEACHER_USER", "ADMIN_USER")
                .antMatchers(HttpMethod.DELETE, "/api/v1/user-register-tutorial/**").hasAnyAuthority("TEACHER_USER", "ADMIN_USER")
                .antMatchers(HttpMethod.GET, "/api/v1/user-register-tutorial-page/**").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/user-register-tutorial-page/**").hasAnyAuthority("TEACHER_USER")
                .antMatchers(HttpMethod.PUT, "/api/v1/user-register-tutorial-page/**").hasAnyAuthority("TEACHER_USER", "ADMIN_USER")
                .antMatchers(HttpMethod.DELETE, "/api/v1/user-register-tutorial-page/**").hasAnyAuthority("TEACHER_USER", "ADMIN_USER")
                ...
                .antMatchers(HttpMethod.PUT, "/api/v1/user-attendance/section-student/**").hasAnyAuthority("ADMIN_USER", "TEACHER_USER", "STUDENT_USER")
                ...
                .antMatchers(HttpMethod.DELETE, "/api/v1/holiday/**").hasAnyAuthority("ADMIN_USER")
                .antMatchers(HttpMethod.GET, "/api/v1/holiday/**").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/holiday/**").hasAnyAuthority("ADMIN_USER")
                .antMatchers(HttpMethod.PUT, "/api/v1/holiday/**").hasAnyAuthority("ADMIN_USER")
                ...
                .antMatchers(HttpMethod.DELETE, "/api/v1/user-register-join-semester/**").hasAnyAuthority("ADMIN_USER", "PARENT_USER", "STUDENT_USER")
                ...
                .antMatchers(HttpMethod.PUT, "/api/v1/section/**").hasAnyAuthority("ADMIN_USER", "TEACHER_USER")
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/exercise-submission/**").hasAnyAuthority("STUDENT_USER", "PARENT_USER")
                .antMatchers(HttpMethod.PUT, "/api/v1/exercise-submission/**").hasAnyAuthority("STUDENT_USER", "PARENT_USER")
                .antMatchers(HttpMethod.DELETE, "/api/v1/exercise-submission/**").hasAnyAuthority("STUDENT_USER", "PARENT_USER")
                .antMatchers(HttpMethod.GET, "/api/v1/contest-submission/**").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/contest-submission/**").hasAnyAuthority("STUDENT_USER", "PARENT_USER", "ADMIN_USER")
                .antMatchers(HttpMethod.PUT, "/api/v1/contest-submission/**").hasAnyAuthority("STUDENT_USER", "PARENT_USER")
                .antMatchers(HttpMethod.DELETE, "/api/v1/contest-submission/**").hasAnyAuthority("STUDENT_USER", "PARENT_USER")
